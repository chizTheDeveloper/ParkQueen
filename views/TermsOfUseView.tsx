  ...
  return (
    <div className="min-h-full bg-dark-900 text-white pt-4 pb-20 px-4 max-w-md mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-xl font-bold text-white tracking-wide">Terms of Use</h1>
      </div>

      <div className="bg-[#07162c]/65 border border-white/5 backdrop-blur-md rounded-3xl p-5 shadow-xl text-gray-300 text-xs space-y-4">
        <h3 className="text-lg font-bold text-white">Terms of Use for ParkQueen</h3>
        <p className="leading-relaxed"><strong>Effective Date:</strong> May 11, 2026</p>

        <h4 className="text-sm font-bold text-white mt-4">1. Acceptance of Terms</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">2. Description of Service</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">3. AI Sign Decoder: Disclaimer of Accuracy</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">4. P2P Rental Marketplace (Hosts & Guests)</h4>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h4 className="text-sm font-bold text-white mt-4">5. Community "Pings" & User Conduct</h4>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h4 className="text-sm font-bold text-white mt-4">6. Payments and Fees</h4>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h4 className="text-sm font-bold text-white mt-4">7. Intellectual Property</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">8. Termination</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">9. Governing Law</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">10. Contact</h4>
