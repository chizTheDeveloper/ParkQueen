  ...
  return (
    <div className="min-h-full bg-dark-900 text-white pt-4 pb-20 px-4 max-w-md mx-auto">
      ...
      <div className="bg-[#07162c]/65 border border-white/5 backdrop-blur-md rounded-3xl p-5 shadow-xl text-gray-300 text-xs space-y-4">
        <h3 className="text-lg font-bold text-white">Privacy Policy for ParkQueen</h3>
        <p className="leading-relaxed">
          <strong>Effective Date:</strong> May 11, 2026<br/>
          <strong>Last Updated:</strong> May 11, 2026
        </p>

        <h4 className="text-sm font-bold text-white mt-4">1. Introduction</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">2. Information We Collect</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">3. How We Use Your Information</h4>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h4 className="text-sm font-bold text-white mt-4">4. Data Sharing & Third Parties</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">5. Your Rights & Choices</h4>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h4 className="text-sm font-bold text-white mt-4">6. Data Security & Retention</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">7. Changes to This Policy</h4>
        ...
        <h4 className="text-sm font-bold text-white mt-4">8. Contact Us</h4>
        <p className="leading-relaxed">
